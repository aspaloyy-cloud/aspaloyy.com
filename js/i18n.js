...
en: {
  ...
  "path.2.body": "I went to Turkey to find my feet in a different environment and to try for a place at a Turkish university. I enrolled at a faculty of oral health — not the field I was aiming for, but a step: it gave me a basis to stay and a year to build on. The plan was to move from there into the direction I actually wanted.<br><br>In parallel, entirely on my own, I learned development: how software is actually made, signed, published and maintained. The deeper I went, the more my thinking moved from studying to practice and work — and that is where I found the <strong>Ausbildung</strong> programme. Passing exams matters less to me than getting further in real work and building my own infrastructure. Everything that follows on this page started in that year.",
...
de: {
  ...
  "path.2.body": "Ich ging in die Türkei, um mich in einer anderen Umgebung zurechtzufinden und mich um einen Studienplatz an einer türkischen Universität zu bemühen. Eingeschrieben war ich an einer Fakultät für Mundgesundheit — nicht das Fach, das ich anstrebte, sondern ein Zwischenschritt: Es gab mir eine Grundlage zu bleiben und ein Jahr, auf dem sich aufbauen ließ. Der Plan war, von dort in die Richtung zu wechseln, die ich wirklich wollte.<br><br>Parallel dazu habe ich mir vollständig selbst die Entwicklung beigebracht: wie Software wirklich gebaut, signiert, veröffentlicht und gepflegt wird. Je tiefer ich einstieg, desto mehr verschob sich mein Denken vom Studieren hin zu Praxis und Arbeit — und genau dort bin ich auf die <strong>Ausbildung</strong> gestoßen. Prüfungen zu bestehen ist mir weniger wichtig, als in echter Arbeit weiterzukommen und eine eigene Infrastruktur aufzubauen. Alles Weitere auf dieser Seite hat in diesem Jahr begonnen.",
...
ru: {
  ...
  "path.2.body": "Я поехал в Турцию, чтобы адаптироваться в другой среде и попробовать поступить в турецкий вуз. Поступил на факультет здоровья полости рта — не то направление, которое мне было нужно, а ступень: оно давало основание остаться и год, на который можно опереться. Дальше я планировал перейти в то направление, которое мне действительно нужно.<br><br>Параллельно, полностью самостоятельно, осваивал разработку: как программы реально делаются, подписываются, публикуются и поддерживаются. Чем глубже я в это уходил, тем больше думал не про учёбу, а про практику и работу — на этом моменте я и нашёл программу <strong>Ausbildung</strong>. Мне важнее не сдавать сессии, а продвигаться в реальной работе и развивать собственную инфраструктуру. Всё, что дальше на этой странице, началось в тот год.",
...
tr: {
  ...
  "path.2.body": "Farklı bir ortama uyum sağlamak ve bir Türk üniversitesine girmeyi denemek için Türkiye'ye gittim. Ağız sağlığı fakültesine kaydoldum — hedeflediğim alan değil, bir basamaktı: kalmak için bir dayanak ve üzerine bir şeyler kurabileceğim bir yıl verdi. Planım, oradan gerçekten istediğim alana geçmekti.<br><br>Bu süre boyunca tamamen kendi başıma geliştirmeyi öğrendim: yazılımın gerçekte nasıl yapıldığını, imzalandığını, yayınlandığını ve sürdürüldüğünü. Konuya ne kadar derinleştiysem, düşüncem okumaktan pratiğe ve işe o kadar kaydı — <strong>Ausbildung</strong> programını da tam o noktada buldum. Benim için sınavları geçmekten çok, gerçek işte ilerlemek ve kendi altyapımı kurmak önemli. Bu sayfadaki her şey o yıl başladı.",
...
ky: {
  ...
  "path.2.body": "Башка чөйрөгө көнүү жана түрк университетине өтүүнү сынап көрүү үчүн Түркияга бардым. Ооз көңдөйүнүн ден соолугу факультетине кирдим — мага керек болгон багыт эмес, тепкич болчу: ал жерде калууга негиз жана таянууга боло турган бир жыл берди. Андан ары чындап керек болгон багытка өтүүнү пландап жүргөм.<br><br>Ошол убакта толугу менен өз алдынча иштеп чыгууну үйрөндүм: программа чындыгында кантип жасалат, кол коюлат, жарыяланат жана колдоого алынат. Канчалык тереңдеген сайын оюм окуудан практикага жана жумушка ооп жүрдү — <strong>Ausbildung</strong> программасын дал ошол учурда таптым. Мен үчүн сессия тапшыруудан көрө, чыныгы иште алдыга жылуу жана өз инфраструктурамды куруу маанилүү. Бул барактагы калган нерселердин баары ошол жылы башталды.",
  "path.3.date": "Декабрь 2025",
